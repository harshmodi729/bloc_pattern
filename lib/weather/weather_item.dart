...
String weatherItemToJson(WeatherItem data) => json.encode(data.toJson());
...
class Main {
  ...
  factory Main.fromJson(Map<String, dynamic> json) => Main(
        temp: json["temp"].toDouble() - 272.5,
        feelsLike: json["feels_like"].toDouble(),
        tempMin: json["temp_min"].toDouble() - 272.5,
        tempMax: json["temp_max"].toDouble() - 272.5,
